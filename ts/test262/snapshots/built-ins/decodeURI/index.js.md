...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:36:142: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals((scope->*"decodeURI").call(make_shared<String>("http://unipro.ru/%0Babout")), make_shared<String>("http://unipro.ru/\\u000babout")))) {␊
                                                                                                                                                   ^~~~~~␊
      1 error generated.`,
    }
