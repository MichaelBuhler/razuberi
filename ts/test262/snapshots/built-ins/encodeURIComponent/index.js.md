...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      ...
      scope->*"leftHandSideValue" = _strictNotEquals((scope->*"encodeURIComponent").call(make_shared<String>("http://unipro.ru/\\u000babout")), make_shared<String>("http%3A%2F%2Funipro.ru%2F%0Babout"));␊
                                                                                                                               ^~~~~~␊
      <stdin>:253:134: error: universal character name refers to a control character␊
      return _if(scope->*"leftHandSideValue") ? _strictNotEquals((scope->*"encodeURIComponent").call(make_shared<String>("http://unipro.ru/\\u000babout")), make_shared<String>("http%3A%2F%2Funipro.ru%2F%0babout")) : GetValue(scope->*"leftHandSideValue");␊
                                                                                                                                           ^~~~~~␊
      2 errors generated.`,
    }
