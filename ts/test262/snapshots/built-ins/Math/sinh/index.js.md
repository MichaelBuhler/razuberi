# Snapshot report for `built-ins/Math/sinh/index.js`

The actual snapshot is saved in `index.js.snap`.

Generated by [AVA](https://avajs.dev).

## built-ins/Math/sinh/length.js
...
## built-ins/Math/sinh/not-a-constructor.js
...
## built-ins/Math/sinh/prop-desc.js
