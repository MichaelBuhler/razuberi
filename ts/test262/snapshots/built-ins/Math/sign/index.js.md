# Snapshot report for `built-ins/Math/sign/index.js`

The actual snapshot is saved in `index.js.snap`.

Generated by [AVA](https://avajs.dev).

## built-ins/Math/sign/length.js
...
## built-ins/Math/sign/not-a-constructor.js
...
## built-ins/Math/sign/prop-desc.js
