# Snapshot report for `built-ins/Math/tanh/index.js`

The actual snapshot is saved in `index.js.snap`.

Generated by [AVA](https://avajs.dev).

## built-ins/Math/tanh/length.js
...
## built-ins/Math/tanh/not-a-constructor.js
...
## built-ins/Math/tanh/prop-desc.js
