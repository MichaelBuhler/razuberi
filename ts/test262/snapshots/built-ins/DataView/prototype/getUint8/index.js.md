# Snapshot report for `built-ins/DataView/prototype/getUint8/index.js`
...
## built-ins/DataView/prototype/getUint8/resizable-buffer.js
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      ...
      shared_ptr<Value> _anonymous_10 (shared_ptr<Scope> scope, shared_ptr<Value> _this, vector<shared_ptr<Value> > arguments) {␊
                        ^␊
      <stdin>:271:19: error: redefinition of '_anonymous_11'␊
