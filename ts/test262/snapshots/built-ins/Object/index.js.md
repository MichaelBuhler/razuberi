...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:38:33: error: right hand operand to ->* has non-pointer-to-member type 'const char [6]'␊
      (scope->*"assert").call((!!scope->*"n_obj"->*"flag", make_shared<String>("The value of !!n_obj[\\"flag\\"] is expected to be true")));␊
                                      ^  ~~~~~~~␊
      1 error generated.`,
    }
