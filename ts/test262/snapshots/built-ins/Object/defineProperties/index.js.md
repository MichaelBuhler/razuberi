...
> | Execute | ❌ Fail | An error occurred while executing the test program. |
    ...
    Error {
      message: 'Uncaught TypeError: defineProperties is not a function',
    }
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:39:27: error: invalid operands to binary expression ('const char [2]' and 'const char [6]')␊
      scope->*"properties" = "a"&"value"&make_shared<Number>(100)|"enumerable"&make_shared<Boolean>(true)|"writable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true)|"b"&"get"&scope->*"get_func"|"set"&scope->*"set_func"|"enumerable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true)|"c"&"value"&make_shared<Number>(200)|"enumerable"&make_shared<Boolean>(true)|"writable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true);␊
                             ~~~^~~~~~~~␊
      <stdin>:39:184: error: invalid operands to binary expression ('const char [2]' and 'const char [4]')␊
      scope->*"properties" = "a"&"value"&make_shared<Number>(100)|"enumerable"&make_shared<Boolean>(true)|"writable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true)|"b"&"get"&scope->*"get_func"|"set"&scope->*"set_func"|"enumerable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true)|"c"&"value"&make_shared<Number>(200)|"enumerable"&make_shared<Boolean>(true)|"writable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true);␊
                                                                                                                                                                                          ~~~^~~~~~␊
      <stdin>:39:320: error: invalid operands to binary expression ('const char [2]' and 'const char [6]')␊
      scope->*"properties" = "a"&"value"&make_shared<Number>(100)|"enumerable"&make_shared<Boolean>(true)|"writable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true)|"b"&"get"&scope->*"get_func"|"set"&scope->*"set_func"|"enumerable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true)|"c"&"value"&make_shared<Number>(200)|"enumerable"&make_shared<Boolean>(true)|"writable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true);␊
                                                                                                                                                                                                                                                                                                                                  ~~~^~~~~~~~␊
      3 errors generated.`,
    }
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:39:65: error: invalid operands to binary expression ('const char [2]' and 'const char [4]')␊
      (scope->*"Object"->*"defineProperties").call((scope->*"arg", "0"&"get"&_fn(scope, _anonymous_9)));␊
                                                                   ~~~^~~~~~␊
