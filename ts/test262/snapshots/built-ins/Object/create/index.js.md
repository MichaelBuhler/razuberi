...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:37:82: error: invalid operands to binary expression ('const char [2]' and 'const char [6]')␊
      scope->*"newObj" = (scope->*"Object"->*"create").call((make_shared<Object>(), "0"&"value"&make_shared<Number>(100)|"enumerable"&make_shared<Boolean>(true)|"writable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true)|"1"&"get"&scope->*"getFunc"|"set"&scope->*"setFunc"|"enumerable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true)|"2"&"value"&make_shared<Number>(200)|"enumerable"&make_shared<Boolean>(true)|"writable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true)));␊
                                                                                    ~~~^~~~~~~~␊
      <stdin>:37:239: error: invalid operands to binary expression ('const char [2]' and 'const char [4]')␊
      scope->*"newObj" = (scope->*"Object"->*"create").call((make_shared<Object>(), "0"&"value"&make_shared<Number>(100)|"enumerable"&make_shared<Boolean>(true)|"writable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true)|"1"&"get"&scope->*"getFunc"|"set"&scope->*"setFunc"|"enumerable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true)|"2"&"value"&make_shared<Number>(200)|"enumerable"&make_shared<Boolean>(true)|"writable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true)));␊
                                                                                                                                                                                                                                                 ~~~^~~~~~␊
      <stdin>:37:373: error: invalid operands to binary expression ('const char [2]' and 'const char [6]')␊
      scope->*"newObj" = (scope->*"Object"->*"create").call((make_shared<Object>(), "0"&"value"&make_shared<Number>(100)|"enumerable"&make_shared<Boolean>(true)|"writable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true)|"1"&"get"&scope->*"getFunc"|"set"&scope->*"setFunc"|"enumerable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true)|"2"&"value"&make_shared<Number>(200)|"enumerable"&make_shared<Boolean>(true)|"writable"&make_shared<Boolean>(true)|"configurable"&make_shared<Boolean>(true)));␊
                                                                                                                                                                                                                                                                                                                                                                                       ~~~^~~~~~~~␊
      3 errors generated.`,
    }
