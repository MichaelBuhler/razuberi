...
> | Execute | ❌ Fail | An error occurred while executing the test program. |
    ...
    Error {
      message: 'Uncaught Test262Error: #1: __instance = new Object(true); __instance.indexOf = String.prototype.indexOf;  __instance.indexOf(true, false) === 0. Actual: -1.000000',
    }
...
> | Execute | ❌ Fail | An error occurred while executing the test program. |
    ...
    Error {
      message: 'Uncaught Test262Error: #1: __instance = new Boolean; __instance.indexOf = String.prototype.indexOf;  __instance.indexOf("A"!=="\\u0041", function(){return 0;}(),null) === 0. Actual: -1.000000',
    }
...
> | Execute | ❌ Fail | An error occurred while executing the test program. |
    ...
    Error {
      message: 'Uncaught Test262Error: #1: var x; new String("undefined").indexOf(x) === 0. Actual: -1.000000',
    }
...
> | Execute | ❌ Fail | An error occurred while executing the test program. |
    ...
    Error {
      message: 'Uncaught Test262Error: #1: String("undefined").indexOf(undefined) === 0. Actual: -1.000000',
    }
