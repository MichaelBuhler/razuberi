...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:38:76: error: use of undeclared identifier '_this'␊
      scope->*"split" = (scope->*"String"->*"prototype"->*"split"->*"bind").call(_this);␊
                                                                                 ^␊
      <stdin>:256:19: error: redefinition of '_anonymous_9'␊
      shared_ptr<Value> _anonymous_9 (shared_ptr<Scope> scope, shared_ptr<Value> _this, vector<shared_ptr<Value> > arguments) {␊
                        ^␊
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: 'No handler for `RegExpLiteral` in `libRazuberiTypeof()` utility',
    }
