# Snapshot report for `built-ins/String/prototype/toLowerCase/index.js`

The actual snapshot is saved in `index.js.snap`.

Generated by [AVA](https://avajs.dev).

## built-ins/String/prototype/toLowerCase/Final_Sigma_U180E.js
...
> | Execute | ❌ Fail | An error occurred while executing the test program. |
    ...
    Error {
      message: 'Uncaught TypeError: toLowerCase is not a function',
    }
...
## built-ins/String/prototype/toLowerCase/not-a-constructor.js
...
## built-ins/String/prototype/toLowerCase/supplementary_plane.js
...
## built-ins/String/prototype/toLowerCase/this-value-not-obj-coercible.js
