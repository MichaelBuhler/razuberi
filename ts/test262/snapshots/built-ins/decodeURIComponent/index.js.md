...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:36:153: error: universal character name refers to a control character␊
      if (_test(_strictNotEquals((scope->*"decodeURIComponent").call(make_shared<String>("http://unipro.ru/%0Babout")), make_shared<String>("http://unipro.ru/\\u000babout")))) {␊
                                                                                                                                                              ^~~~~~␊
      1 error generated.`,
    }
...
> | Execute | ❌ Fail | An error occurred while executing the test program. |
    ...
    Error {
      message: 'Uncaught Test262Error: #1.2: new decodeURIComponent() throw TypeError. Actual: ReferenceError: "decodeURIComponent" is not defined',
    }
