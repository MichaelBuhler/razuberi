...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      ...
      shared_ptr<Value> _anonymous_13 (shared_ptr<Scope> scope, shared_ptr<Value> _this, vector<shared_ptr<Value> > arguments) {␊
                        ^␊
      <stdin>:275:19: error: redefinition of '_andExpression_4'␊
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      ...
      scope->*"a"->*"5" = make_shared<Number>(Infinity);␊
                                              ^␊
      <stdin>:44:95: error: use of undeclared identifier 'Infinity'␊
      (scope->*"assert"->*"sameValue").call(((scope->*"a"->*"lastIndexOf").call(make_shared<Number>(Infinity)), make_shared<Number>(5), make_shared<String>("a.lastIndexOf(1E+309)")));␊
                                                                                                    ^␊
      2 errors generated.`,
    }
