...
> | Execute | ❌ Fail | An error occurred while executing the test program. |
    ...
    Error {
      message: 'Uncaught Test262Error: Expected SameValue(«ReferenceError: "RegExp" is not defined», «invalof») to be true',
    }
...
> | Execute | ❌ Fail | An error occurred while executing the test program. |
    ...
    Error {
      message: 'Uncaught Test262Error: Expected SameValue(«ReferenceError: "RegExp" is not defined», «intostr») to be true',
    }
...
> | Execute | ❌ Fail | An error occurred while executing the test program. |
    ...
    Error {
      message: 'Uncaught Test262Error: Expected SameValue(«false», «true») to be true',
    }
