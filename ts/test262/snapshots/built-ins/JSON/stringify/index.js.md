...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:45:26: error: invalid operands to binary expression ('const char [3]' and 'const char [3]')␊
      scope->*"indirect" = "p1"&"p2"&make_shared<Object>();␊
                           ~~~~^~~~~␊
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:238:40: error: invalid operands to binary expression ('const char [2]' and 'const char [2]')␊
      (scope->*"JSON"->*"stringify").call("a"&"b"&scope->*"handle"->*"proxy");␊
                                          ~~~^~~~␊
      1 error generated.`,
    }
