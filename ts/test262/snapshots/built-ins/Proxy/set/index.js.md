...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:271:15: error: right hand operand to ->* has non-pointer-to-member type 'const char [10]'␊
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:267:15: error: right hand operand to ->* has non-pointer-to-member type 'const char [10]'␊
      if (_if(!scope->*"overrides")) {␊
                    ^  ~~~~~~~~~~~␊
