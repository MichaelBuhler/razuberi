...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:264:15: error: right hand operand to ->* has non-pointer-to-member type 'const char [10]'␊
      if (_if(!scope->*"overrides")) {␊
                    ^  ~~~~~~~~~~~␊
      1 error generated.`,
    }
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:296:15: error: right hand operand to ->* has non-pointer-to-member type 'const char [10]'␊
      if (_if(!scope->*"overrides")) {␊
                    ^  ~~~~~~~~~~~␊
