...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:42:114: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals((scope->*"String"->*"fromCharCode").call(make_shared<Number>(11)), make_shared<String>("\\u000b")))) {␊
                                                                                                                       ^~~~~~␊
      1 error generated.`,
    }
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:48:70: error: universal character name refers to a control character␊
      if (_if(_strictEquals(make_shared<String>("v"), make_shared<String>("\\u000b")))) {␊
                                                                           ^~~~~~␊
      1 error generated.`,
    }
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:33:113: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals((scope->*"String"->*"fromCharCode").call(make_shared<Number>(0)), make_shared<String>("\\u0000")))) {␊
                                                                                                                      ^~~~~~␊
      1 error generated.`,
    }
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:33:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u0000"), make_shared<String>("\\u0000")))) {␊
                                                    ^~~~~~␊
      <stdin>:33:78: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u0000"), make_shared<String>("\\u0000")))) {␊
                                                                                   ^~~~~~␊
      2 errors generated.`,
    }
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:33:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u0000"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("0"))))) {␊
                                                    ^~~~~~␊
      <stdin>:36:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u0001"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("1"))))) {␊
                                                    ^~~~~~␊
      <stdin>:39:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u0002"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("2"))))) {␊
                                                    ^~~~~~␊
      <stdin>:42:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u0003"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("3"))))) {␊
                                                    ^~~~~~␊
      <stdin>:45:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u0004"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("4"))))) {␊
                                                    ^~~~~~␊
      <stdin>:48:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u0005"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("5"))))) {␊
                                                    ^~~~~~␊
      <stdin>:51:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u0006"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("6"))))) {␊
                                                    ^~~~~~␊
      <stdin>:54:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u0007"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("7"))))) {␊
                                                    ^~~~~~␊
      <stdin>:66:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u000b"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("11"))))) {␊
                                                    ^~~~~~␊
      <stdin>:75:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u000e"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("14"))))) {␊
                                                    ^~~~~~␊
      <stdin>:78:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u000f"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("15"))))) {␊
                                                    ^~~~~~␊
      11 errors generated.`,
    }
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:33:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u0001F"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("1"))+make_shared<String>("F")))) {␊
                                                    ^~~~~~␊
      <stdin>:34:93: error: universal character name refers to a control character␊
          throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#1: '\\u0001F' === String.fromCharCode('1') + 'F'")));␊
                                                                                                  ^~~~~~␊
      <stdin>:36:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u0002E"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("2"))+make_shared<String>("E")))) {␊
                                                    ^~~~~~␊
      <stdin>:37:93: error: universal character name refers to a control character␊
          throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#2: '\\u0002E' === String.fromCharCode('2') + 'E'")));␊
                                                                                                  ^~~~~~␊
      <stdin>:39:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u0003D"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("3"))+make_shared<String>("D")))) {␊
                                                    ^~~~~~␊
      <stdin>:40:93: error: universal character name refers to a control character␊
          throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#3: '\\u0003D' === String.fromCharCode('3') + 'D'")));␊
                                                                                                  ^~~~~~␊
      <stdin>:42:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u0004C"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("4"))+make_shared<String>("C")))) {␊
                                                    ^~~~~~␊
      <stdin>:43:93: error: universal character name refers to a control character␊
          throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#4: '\\u0004C' === String.fromCharCode('4') + 'C'")));␊
                                                                                                  ^~~~~~␊
      <stdin>:45:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u0005B"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("5"))+make_shared<String>("B")))) {␊
                                                    ^~~~~~␊
      <stdin>:46:93: error: universal character name refers to a control character␊
          throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#5: '\\u0005B' === String.fromCharCode('5') + 'B'")));␊
                                                                                                  ^~~~~~␊
      <stdin>:48:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u0006A"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("6"))+make_shared<String>("A")))) {␊
                                                    ^~~~~~␊
      <stdin>:49:93: error: universal character name refers to a control character␊
          throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#6: '\\u0006A' === String.fromCharCode('6') + 'A'")));␊
                                                                                                  ^~~~~~␊
      <stdin>:51:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u00079"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("7"))+make_shared<String>("9")))) {␊
                                                    ^~~~~~␊
      <stdin>:52:93: error: universal character name refers to a control character␊
          throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#7: '\\u00079' === String.fromCharCode('7') + '9'")));␊
                                                                                                  ^~~~~~␊
      <stdin>:63:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u000b5"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("11"))+make_shared<String>("5")))) {␊
                                                    ^~~~~~␊
      <stdin>:64:93: error: universal character name refers to a control character␊
          throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#B: '\\u000b5' === String.fromCharCode('11') + '5'")));␊
                                                                                                  ^~~~~~␊
      <stdin>:72:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u000e2"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("14"))+make_shared<String>("2")))) {␊
                                                    ^~~~~~␊
      <stdin>:73:93: error: universal character name refers to a control character␊
          throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#E: '\\u000e2' === String.fromCharCode('14') + '2'")));␊
                                                                                                  ^~~~~~␊
      <stdin>:75:47: error: universal character name refers to a control character␊
      if (_if(_strictNotEquals(make_shared<String>("\\u000f1"), (scope->*"String"->*"fromCharCode").call(make_shared<String>("15"))+make_shared<String>("1")))) {␊
                                                    ^~~~~~␊
