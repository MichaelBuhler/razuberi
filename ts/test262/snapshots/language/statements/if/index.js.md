...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      ...
      if (_test(make_shared<Boolean>(true))) if (_test(make_shared<Boolean>(true))) else throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#2.1: At embedded \\"if/else\\" constructions engine must select right branches")));␊
                                                                                    ^␊
      <stdin>:33:245: warning: add explicit braces to avoid dangling else [-Wdangling-else]␊
      if (_test(make_shared<Boolean>(true))) if (_test(make_shared<Boolean>(false))) throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#1.1: At embedded \\"if/else\\" constructions engine must select right branches")));else ␊
                                                                                                                                                                                                                                                          ^␊
      <stdin>:35:245: warning: add explicit braces to avoid dangling else [-Wdangling-else]␊
      if (_test(make_shared<Boolean>(false))) if (_test(make_shared<Boolean>(true))) throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#3.1: At embedded \\"if/else\\" constructions engine must select right branches")));else throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#3.2: At embedded \\"if/else\\" constructions engine must select right branches")));␊
                                                                                                                                                                                                                                                          ^␊
      <stdin>:36:245: warning: add explicit braces to avoid dangling else [-Wdangling-else]␊
