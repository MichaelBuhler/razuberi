...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:48:21: error: right hand operand to ->* has non-pointer-to-member type 'const char [2]'␊
          if (_test(!scope->*"e")) {␊
                          ^  ~~~␊
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:39:17: error: right hand operand to ->* has non-pointer-to-member type 'const char [2]'␊
      if (_test(!scope->*"x")) {␊
                      ^  ~~~␊
      1 error generated.`,
    }
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:41:17: error: right hand operand to ->* has non-pointer-to-member type 'const char [2]'␊
      if (_test(!scope->*"x")) {␊
                      ^  ~~~␊
