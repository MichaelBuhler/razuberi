...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      ...
      _this->*"__declared__var" = make_shared<String>("baloon");␊
      ^␊
      <stdin>:34:28: error: use of undeclared identifier '_this'␊
      if (_test(_strictNotEquals(_this->*"__declared__var", make_shared<String>("baloon")))) {␊
                                 ^␊
      <stdin>:35:153: error: use of undeclared identifier '_this'␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1: this['__declared__var'] === \\"baloon\\". Actual:  this['__declared__var'] ===")+_this->*"__declared__var");␊
                                                                                                                                                              ^␊
      3 errors generated.`,
    }
