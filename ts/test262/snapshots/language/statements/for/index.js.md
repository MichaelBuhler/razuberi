...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:245:17: error: right hand operand to ->* has non-pointer-to-member type 'const char [11]'␊
      if (_test(!scope->*"probeFirst")) scope->*"probeFirst" = _fn(scope, _anonymous_12);else scope->*"probeSecond" = _fn(scope, _anonymous_13);␊
                      ^  ~~~~~~~~~~~~␊
      ...
      shared_ptr<Value> _anonymous_11 (shared_ptr<Scope> scope, shared_ptr<Value> _this, vector<shared_ptr<Value> > arguments) {␊
                        ^␊
      <stdin>:260:17: error: right hand operand to ->* has non-pointer-to-member type 'const char [11]'␊
      if (_test(!scope->*"probeFirst")) scope->*"probeFirst" = _fn(scope, _anonymous_12);else scope->*"probeSecond" = _fn(scope, _anonymous_13);␊
                      ^  ~~~~~~~~~~~~␊
