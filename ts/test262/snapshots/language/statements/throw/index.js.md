...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:245:51: error: right hand operand to ->* has non-pointer-to-member type 'const char [2]'␊
      return _test(scope->*"leftHandSideValue") ? !scope->*"b" : GetValue(scope->*"leftHandSideValue");␊
                                                        ^  ~~~␊
      1 error generated.`,
    }
