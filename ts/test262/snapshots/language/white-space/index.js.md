...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      ...
      if (_test(_strictNotEquals(make_shared<String>("\\u000bstr\\u000bing\\u000b"), make_shared<String>("\\u000bstr\\u000bing\\u000b")))) {␊
                                                                                                                         ^~~~~~␊
      <stdin>:34:76: error: universal character name refers to a control character␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1: \\"\\u000bstr\\u000bing\\u000b\\" === \\"\\\\u000Bstr\\\\u000Bing\\\\u000B\\""));␊
                                                                                 ^~~~~~␊
      <stdin>:34:85: error: universal character name refers to a control character␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1: \\"\\u000bstr\\u000bing\\u000b\\" === \\"\\\\u000Bstr\\\\u000Bing\\\\u000B\\""));␊
                                                                                          ^~~~~~␊
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:35:87: error: universal character name refers to a control character␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1: var x = 0; //\\u000bsingle\\u000bline\\u000bcomment\\u000bx = 1; x === 0. Actual: ")+scope->*"x");␊
                                                                                            ^~~~~~␊
      <stdin>:35:99: error: universal character name refers to a control character␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1: var x = 0; //\\u000bsingle\\u000bline\\u000bcomment\\u000bx = 1; x === 0. Actual: ")+scope->*"x");␊
                                                                                                        ^~~~~~␊
      <stdin>:35:109: error: universal character name refers to a control character␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1: var x = 0; //\\u000bsingle\\u000bline\\u000bcomment\\u000bx = 1; x === 0. Actual: ")+scope->*"x");␊
                                                                                                                  ^~~~~~␊
      <stdin>:35:122: error: universal character name refers to a control character␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1: var x = 0; //\\u000bsingle\\u000bline\\u000bcomment\\u000bx = 1; x === 0. Actual: ")+scope->*"x");␊
                                                                                                                               ^~~~~~␊
      4 errors generated.`,
    }
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:35:87: error: universal character name refers to a control character␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1: var x = 0; /*\\u000bmulti\\u000bline\\u000bcomment\\u000bx = 1;*/ x === 0. Actual: ")+scope->*"x");␊
                                                                                            ^~~~~~␊
      <stdin>:35:98: error: universal character name refers to a control character␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1: var x = 0; /*\\u000bmulti\\u000bline\\u000bcomment\\u000bx = 1;*/ x === 0. Actual: ")+scope->*"x");␊
                                                                                                       ^~~~~~␊
      <stdin>:35:108: error: universal character name refers to a control character␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1: var x = 0; /*\\u000bmulti\\u000bline\\u000bcomment\\u000bx = 1;*/ x === 0. Actual: ")+scope->*"x");␊
                                                                                                                 ^~~~~~␊
      <stdin>:35:121: error: universal character name refers to a control character␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1: var x = 0; /*\\u000bmulti\\u000bline\\u000bcomment\\u000bx = 1;*/ x === 0. Actual: ")+scope->*"x");␊
                                                                                                                              ^~~~~~␊
      4 errors generated.`,
    }
