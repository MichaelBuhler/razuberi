...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:238:87: error: invalid operands to binary expression ('const char [2]' and 'const char [2]')␊
      ...
      shared_ptr<Value> _anonymous_10 (shared_ptr<Scope> scope, shared_ptr<Value> _this, vector<shared_ptr<Value> > arguments) {␊
                        ^␊
      <stdin>:260:87: error: invalid operands to binary expression ('const char [2]' and 'const char [2]')␊
      scope->*"_b" = _test(_strictEquals(scope->*"_a", _void(make_shared<Number>(0)))) ? "w"&"x"&make_shared<Undefined>()|"z"&make_shared<Number>(7) : GetValue(scope->*"_a");␊
                                                                                         ~~~^~~~␊
      <stdin>:274:19: error: redefinition of '_anonymous_11'␊
      shared_ptr<Value> _anonymous_11 (shared_ptr<Scope> scope, shared_ptr<Value> _this, vector<shared_ptr<Value> > arguments) {␊
