...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:34:11: error: right hand operand to ->* has non-pointer-to-member type 'const char [2]'␊
          !scope->*"x";␊
                ^  ~~~␊
      <stdin>:35:114: error: right hand operand to ->* has non-pointer-to-member type 'const char [2]'␊
      throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1.1: !x throw ReferenceError. Actual: ")+!scope->*"x");␊
                                                                                                                       ^  ~~~␊
      2 errors generated.`,
    }
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      ...
      if (_test(_strictNotEquals(!scope->*"object", make_shared<Boolean>(false)))) {␊
                                       ^  ~~~~~~~~␊
      <stdin>:70:157: error: right hand operand to ->* has non-pointer-to-member type 'const char [7]'␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1: var object = {valueOf: function() {return 1}}; !object === false. Actual: ")+!scope->*"object");␊
                                                                                                                                                                  ^  ~~~~~~~~␊
      <stdin>:73:34: error: right hand operand to ->* has non-pointer-to-member type 'const char [7]'␊
      if (_test(_strictNotEquals(!scope->*"object", make_shared<Boolean>(false)))) {␊
                                       ^  ~~~~~~~~␊
      <stdin>:74:190: error: right hand operand to ->* has non-pointer-to-member type 'const char [7]'␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#2: var object = {valueOf: function() {return 1}, toString: function() {return 0}}; !object === false. Actual: ")+!scope->*"object");␊
                                                                                                                                                                                                   ^  ~~~~~~~~␊
      <stdin>:77:34: error: right hand operand to ->* has non-pointer-to-member type 'const char [7]'␊
      if (_test(_strictNotEquals(!scope->*"object", make_shared<Boolean>(false)))) {␊
                                       ^  ~~~~~~~~␊
      <stdin>:78:191: error: right hand operand to ->* has non-pointer-to-member type 'const char [7]'␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#3: var object = {valueOf: function() {return 1}, toString: function() {return {}}}; !object === false. Actual: ")+!scope->*"object");␊
                                                                                                                                                                                                    ^  ~~~~~~~~␊
      <stdin>:81:34: error: right hand operand to ->* has non-pointer-to-member type 'const char [7]'␊
      if (_test(_strictNotEquals(!scope->*"object", make_shared<Boolean>(false)))) {␊
                                       ^  ~~~~~~~~␊
      <stdin>:82:197: error: right hand operand to ->* has non-pointer-to-member type 'const char [7]'␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#4: var object = {valueOf: function() {return 1}, toString: function() {throw \\"error\\"}}; !object === false. Actual: ")+!scope->*"object");␊
                                                                                                                                                                                                          ^  ~~~~~~~~␊
      <stdin>:85:34: error: right hand operand to ->* has non-pointer-to-member type 'const char [7]'␊
      if (_test(_strictNotEquals(!scope->*"object", make_shared<Boolean>(false)))) {␊
                                       ^  ~~~~~~~~␊
      <stdin>:86:158: error: right hand operand to ->* has non-pointer-to-member type 'const char [7]'␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#5: var object = {toString: function() {return 1}}; !object === false. Actual: ")+!scope->*"object");␊
                                                                                                                                                                   ^  ~~~~~~~~␊
      <stdin>:89:34: error: right hand operand to ->* has non-pointer-to-member type 'const char [7]'␊
      if (_test(_strictNotEquals(!scope->*"object", make_shared<Boolean>(false)))) {␊
                                       ^  ~~~~~~~~␊
      <stdin>:90:191: error: right hand operand to ->* has non-pointer-to-member type 'const char [7]'␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#6: var object = {valueOf: function() {return {}}, toString: function() {return 1}}; !object === false. Actual: ")+!scope->*"object");␊
                                                                                                                                                                                                    ^  ~~~~~~~~␊
      <stdin>:93:34: error: right hand operand to ->* has non-pointer-to-member type 'const char [7]'␊
      if (_test(_strictNotEquals(!scope->*"object", make_shared<Boolean>(false)))) {␊
                                       ^  ~~~~~~~~␊
      <stdin>:94:197: error: right hand operand to ->* has non-pointer-to-member type 'const char [7]'␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#7: var object = {valueOf: function() {throw \\"error\\"}, toString: function() {return 1}}; !object === false. Actual: ")+!scope->*"object");␊
                                                                                                                                                                                                          ^  ~~~~~~~~␊
      <stdin>:97:34: error: right hand operand to ->* has non-pointer-to-member type 'const char [7]'␊
      if (_test(_strictNotEquals(!scope->*"object", make_shared<Boolean>(false)))) {␊
                                       ^  ~~~~~~~~␊
      <stdin>:98:192: error: right hand operand to ->* has non-pointer-to-member type 'const char [7]'␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#8: var object = {valueOf: function() {return {}}, toString: function() {return {}}}; !object === false. Actual: ")+!scope->*"object");␊
                                                                                                                                                                                                     ^  ~~~~~~~~␊
