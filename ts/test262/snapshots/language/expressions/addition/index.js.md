...
> | Execute | ❌ Fail | An error occurred while executing the test program. |
    ...
    Error {
      message: 'Uncaught Test262Error: [object Object]',
    }
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:36:127: error: no viable overloaded '='␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1: var x = 0; (x = 1) + x === 2. Actual: ")+scope->*"x" = make_shared<Number>(1)+scope->*"x");␊
                                                      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ^ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~␊
      ...
      <stdin>:40:139: error: no viable overloaded '='␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#2: var x = 0; x + (x = 1) === 1. Actual: ")+scope->*"x"+scope->*"x" = make_shared<Number>(1));␊
                                                      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ^ ~~~~~~~~~~~~~~~~~~~~~~␊
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:34:116: error: no viable overloaded '='␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1: (y = 1) + y === 2. Actual: ")+scope->*"y" = make_shared<Number>(1)+scope->*"y");␊
                                                      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ^ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~␊
      /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1/memory:3435:17: note: candidate function not viable: no known conversion from 'shared_ptr<Value>' to 'const shared_ptr<String>' for 1st argument␊
          shared_ptr& operator=(const shared_ptr& __r) _NOEXCEPT;␊
                      ^␊
...
> | Execute | ❌ Fail | An error occurred while executing the test program. |
    ...
    Error {
      message: 'Uncaught Test262Error: #1: "1" + 1 === "11". Actual: 11.000000',
    }
