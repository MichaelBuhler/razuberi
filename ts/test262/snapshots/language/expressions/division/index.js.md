...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:62:128: warning: adding 'bool' to a string does not append to the string [-Wstring-plus-int]␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1: {valueOf: function() {return 1}} / 1 === 1. Actual: ")+"valueOf"&_fn(scope, _anonymous_9)/make_shared<Number>(1));␊
                                                      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^~~~~~~~~~␊
      ...
      <stdin>:65:161: warning: adding 'bool' to a string does not append to the string [-Wstring-plus-int]␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#2: {valueOf: function() {return 1}, toString: function() {return 0}} / 1 === 1. Actual: ")+"valueOf"&_fn(scope, _anonymous_12)|"toString"&_fn(scope, _anonymous_13)/make_shared<Number>(1));␊
                                                      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^~~~~~~~~~␊
      ...
      <stdin>:68:162: warning: adding 'bool' to a string does not append to the string [-Wstring-plus-int]␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#3: {valueOf: function() {return 1}, toString: function() {return {}}} / 1 === 1. Actual: ")+"valueOf"&_fn(scope, _anonymous_16)|"toString"&_fn(scope, _anonymous_17)/make_shared<Number>(1));␊
                                                      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^~~~~~~~~~␊
      ...
      <stdin>:72:170: warning: adding 'bool' to a string does not append to the string [-Wstring-plus-int]␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#4.1: {valueOf: function() {return 1}, toString: function() {throw \\"error\\"}} / 1 === 1. Actual: ")+"valueOf"&_fn(scope, _anonymous_20)|"toString"&_fn(scope, _anonymous_21)/make_shared<Number>(1));␊
                                                      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^~~~~~~~~~␊
      ...
      <stdin>:88:152: error: invalid operands to binary expression ('typename enable_if<!is_array<Number>::value, shared_ptr<Number> >::type' (aka 'std::__1::shared_ptr<Number>') and 'const char [9]')␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#5: 1 / {toString: function() {return 1}} === 1. Actual: ")+make_shared<Number>(1)/"toString"&_fn(scope, _anonymous_23));␊
                                                                                                                                       ~~~~~~~~~~~~~~~~~~~~~~^~~~~~~~~~~␊
      /Users/michael/razuberi/cpp/out/include/value.h:548:25: note: candidate function not viable: no known conversion from 'const char [9]' to 'Reference' for 2nd argument␊
      std::shared_ptr<Number> operator / (std::shared_ptr<Number>, Reference);␊
                              ^␊
      ...
      <stdin>:91:185: error: invalid operands to binary expression ('typename enable_if<!is_array<Number>::value, shared_ptr<Number> >::type' (aka 'std::__1::shared_ptr<Number>') and 'const char [8]')␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#6: 1 / {valueOf: function() {return {}}, toString: function() {return 1}} === 1. Actual: ")+make_shared<Number>(1)/"valueOf"&_fn(scope, _anonymous_26)|"toString"&_fn(scope, _anonymous_27));␊
                                                                                                                                                                        ~~~~~~~~~~~~~~~~~~~~~~^~~~~~~~~~␊
      /Users/michael/razuberi/cpp/out/include/value.h:548:25: note: candidate function not viable: no known conversion from 'const char [8]' to 'Reference' for 2nd argument␊
      std::shared_ptr<Number> operator / (std::shared_ptr<Number>, Reference);␊
                              ^␊
      ...
      throw _newThrowable(scope->*"Test262Error", make_shared<String>("#7.1: 1 / {valueOf: function() {throw \\"error\\"}, toString: function() {return 1}} throw \\"error\\". Actual: ")+make_shared<Number>(1)/"valueOf"&_fn(scope, _anonymous_30)|"toString"&_fn(scope, _anonymous_31));␊
                                                                                                                                                                                      ~~~~~~~~~~~~~~~~~~~~~~^~~~~~~~~~␊
      /Users/michael/razuberi/cpp/out/include/value.h:548:25: note: candidate function not viable: no known conversion from 'const char [8]' to 'Reference' for 2nd argument␊
      std::shared_ptr<Number> operator / (std::shared_ptr<Number>, Reference);␊
                              ^␊
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:36:127: error: no viable overloaded '='␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1: var x = 0; (x = 1) / x === 1. Actual: ")+scope->*"x" = make_shared<Number>(1)/scope->*"x");␊
                                                      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ^ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~␊
      ...
      <stdin>:40:139: error: no viable overloaded '='␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#2: var x = 0; x / (x = 1) === 0. Actual: ")+scope->*"x"/scope->*"x" = make_shared<Number>(1));␊
                                                      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ^ ~~~~~~~~~~~~~~~~~~~~~~␊
      /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1/memory:3435:17: note: candidate function not viable: no known conversion from 'shared_ptr<Number>' to 'const shared_ptr<String>' for 1st argument␊
          shared_ptr& operator=(const shared_ptr& __r) _NOEXCEPT;␊
                      ^␊
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:34:116: error: no viable overloaded '='␊
          throw _newThrowable(scope->*"Test262Error", make_shared<String>("#1: (y = 1) / y === 1. Actual: ")+scope->*"y" = make_shared<Number>(1)/scope->*"y");␊
                                                      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ^ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~␊
      /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1/memory:3435:17: note: candidate function not viable: no known conversion from 'shared_ptr<Number>' to 'const shared_ptr<String>' for 1st argument␊
          shared_ptr& operator=(const shared_ptr& __r) _NOEXCEPT;␊
                      ^␊
