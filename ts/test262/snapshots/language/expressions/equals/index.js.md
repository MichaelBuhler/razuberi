...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      ...
      if (_if(_strictNotEquals((scope->*"eval").call(make_shared<String>("true\\u000b==\\u000b1")), make_shared<Boolean>(true)))) {␊
                                                                              ^~~~~~␊
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:39:51: error: no viable overloaded '='␊
      if (_if(_strictNotEquals(scope->*"x"==scope->*"x" = make_shared<Number>(1), make_shared<Boolean>(false)))) {␊
                               ~~~~~~~~~~~~~~~~~~~~~~~~ ^ ~~~~~~~~~~~~~~~~~~~~~~␊
