...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      ...
      operator==(const vector<_Tp, _Allocator>& __x, const vector<_Tp, _Allocator>& __y)␊
      ^␊
      <stdin>:91:220: warning: result of comparison against a string literal is unspecified (use an explicit string comparison function instead) [-Wstring-compare]␊
      throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#7.1: (1 == {valueOf: function() {throw \\"error\\"}, toString: function() {return 1}}) throw \\"error\\". Actual: ")+make_shared<Number>(1)=="valueOf"&_fn(scope, _anonymous_22)|"toString"&_fn(scope, _anonymous_23)));␊
                                                                                                                                                                                                                                 ^ ~~~~~~~~~␊
      <stdin>:91:220: error: invalid operands to binary expression ('std::shared_ptr<String>' and 'const char [8]')␊
      throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#7.1: (1 == {valueOf: function() {throw \\"error\\"}, toString: function() {return 1}}) throw \\"error\\". Actual: ")+make_shared<Number>(1)=="valueOf"&_fn(scope, _anonymous_22)|"toString"&_fn(scope, _anonymous_23)));␊
                                                                    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^ ~~~~~~~~~␊
      /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1/memory:4125:1: note: candidate function template not viable: no known conversion from 'const char [8]' to 'std::__1::nullptr_t' for 2nd argument␊
      operator==(const shared_ptr<_Tp>& __x, nullptr_t) _NOEXCEPT␊
      ...
      operator==(const vector<_Tp, _Allocator>& __x, const vector<_Tp, _Allocator>& __y)␊
      ^␊
      <stdin>:105:215: warning: result of comparison against a string literal is unspecified (use an explicit string comparison function instead) [-Wstring-compare]␊
      throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#8.1: (1 == {valueOf: function() {return {}}, toString: function() {return {}}}) throw TypeError. Actual: ")+make_shared<Number>(1)=="valueOf"&_fn(scope, _anonymous_26)|"toString"&_fn(scope, _anonymous_27)));␊
                                                                                                                                                                                                                            ^ ~~~~~~~~~␊
      <stdin>:105:215: error: invalid operands to binary expression ('std::shared_ptr<String>' and 'const char [8]')␊
      throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#8.1: (1 == {valueOf: function() {return {}}, toString: function() {return {}}}) throw TypeError. Actual: ")+make_shared<Number>(1)=="valueOf"&_fn(scope, _anonymous_26)|"toString"&_fn(scope, _anonymous_27)));␊
                                                                    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^ ~~~~~~~~~␊
      /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1/memory:4125:1: note: candidate function template not viable: no known conversion from 'const char [8]' to 'std::__1::nullptr_t' for 2nd argument␊
      operator==(const shared_ptr<_Tp>& __x, nullptr_t) _NOEXCEPT␊
