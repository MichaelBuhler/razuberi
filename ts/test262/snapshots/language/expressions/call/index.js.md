...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:34:5: error: use of undeclared identifier '_this'␊
          _this->call();␊
          ^␊
      <stdin>:35:125: error: use of undeclared identifier '_this'␊
      throw static_pointer_cast<Value>(_new(scope->*"Test262Error", make_shared<String>("#1.1: this() throw TypeError. Actual: ")+_this->call()));␊
                                                                                                                                  ^␊
      2 errors generated.`,
    }
