...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      ...
      scope->*"a" = "b"&_fn(scope, _anonymous_9)|"_b"&"c"&make_shared<Number>(42);␊
                                                 ~~~~^~~~␊
      <stdin>:51:82: error: incompatible operand types ('std::shared_ptr<Undefined>' and 'Reference')␊
      (scope->*"assert"->*"sameValue").call(((_if(_fn(scope, _orExpression_5)->call()) ? _void(make_shared<Number>(0)) : GetValue(scope->*"a"->*"b")->*"call").call(scope->*"a")->*"c", make_shared<Number>(42)));␊
                                                                                       ^ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~␊
