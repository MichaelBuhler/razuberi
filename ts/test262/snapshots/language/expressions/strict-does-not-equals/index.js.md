...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      ...
      if (_if((scope->*"eval").call(make_shared<String>("1\\u000b!==\\u000b1")))) {␊
                                                          ^~~~~~␊
      <stdin>:36:62: error: universal character name refers to a control character␊
      if (_if((scope->*"eval").call(make_shared<String>("1\\u000b!==\\u000b1")))) {␊
                                                                   ^~~~~~␊
      <stdin>:60:55: error: universal character name refers to a control character␊
      if (_if((scope->*"eval").call(make_shared<String>("1\\t\\u000b\\f  \\n\\r      !==\\t\\u000b\\f  \\n\\r      1")))) {␊
                                                            ^~~~~~␊
      <stdin>:60:81: error: universal character name refers to a control character␊
      if (_if((scope->*"eval").call(make_shared<String>("1\\t\\u000b\\f  \\n\\r      !==\\t\\u000b\\f  \\n\\r      1")))) {␊
                                                                                 ^~~~~~␊
      4 errors generated.`,
    }
