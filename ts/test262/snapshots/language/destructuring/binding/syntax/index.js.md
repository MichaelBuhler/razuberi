...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:288:81: error: incompatible operand types ('typename enable_if<!is_array<Number>::value, shared_ptr<Number> >::type' (aka 'std::__1::shared_ptr<Number>') and 'Reference')␊
      scope->*"y" = _test(_strictEquals(scope->*"_b", _void(make_shared<Number>(0)))) ? make_shared<Number>(42) : GetValue(scope->*"_b")->*"y";␊
                                                                                      ^ ~~~~~~~~~~~~~~~~~~~~~~~   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~␊
      1 error generated.`,
    }
