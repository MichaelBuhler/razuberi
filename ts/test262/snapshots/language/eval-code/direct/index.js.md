...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:35:78: error: use of undeclared identifier '_this'␊
      (scope->*"assert"->*"sameValue").call((_in(make_shared<String>("arguments"), _this), make_shared<Boolean>(false), make_shared<String>("No global 'arguments' binding")));␊
                                                                                   ^␊
      <stdin>:37:78: error: use of undeclared identifier '_this'␊
      (scope->*"assert"->*"sameValue").call((_in(make_shared<String>("arguments"), _this), make_shared<Boolean>(false), make_shared<String>("No global 'arguments' binding")));␊
                                                                                   ^␊
      2 errors generated.`,
    }
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      message: `<stdin>:36:78: error: use of undeclared identifier '_this'␊
      (scope->*"assert"->*"sameValue").call((_in(make_shared<String>("arguments"), _this), make_shared<Boolean>(false), make_shared<String>("No global 'arguments' binding")));␊
                                                                                   ^␊
      <stdin>:38:78: error: use of undeclared identifier '_this'␊
      (scope->*"assert"->*"sameValue").call((_in(make_shared<String>("arguments"), _this), make_shared<Boolean>(false), make_shared<String>("No global 'arguments' binding")));␊
                                                                                   ^␊
      2 errors generated.`,
    }
...
> | Execute | ⬜ Skip | *This stage did not run.* |
    ...
    Error {
      ...
      (scope->*"assert"->*"sameValue").call((_in(make_shared<String>("arguments"), _this), make_shared<Boolean>(false), make_shared<String>("No global 'arguments' binding")));␊
                                                                                   ^␊
      <stdin>:39:78: error: use of undeclared identifier '_this'␊
      (scope->*"assert"->*"sameValue").call((_in(make_shared<String>("arguments"), _this), make_shared<Boolean>(false), make_shared<String>("No global 'arguments' binding")));␊
                                                                                   ^␊
      <stdin>:246:19: error: redefinition of '_anonymous_9'␊
      shared_ptr<Value> _anonymous_9 (shared_ptr<Scope> scope, shared_ptr<Value> _this, vector<shared_ptr<Value> > arguments) {␊
                        ^␊
      <stdin>:233:19: note: previous definition is here␊
      shared_ptr<Value> _anonymous_9 (shared_ptr<Scope> scope, shared_ptr<Value> _this, vector<shared_ptr<Value> > arguments) {␊
