...
shared_ptr<Value> _Function (shared_ptr<Value> thisArg, shared_ptr<Scope> scope, vector<shared_ptr<Value> > arguments) {
  throw new NotImplementedException("Cannot use the Function function to create new functions at runtime.");
}

shared_ptr<Value> _Function_toString (shared_ptr<Value> thisArg, shared_ptr<Scope> scope, vector<shared_ptr<Value> > arguments) {
  // TODO: needs the context of a `this` arg
  throw new NotImplementedException("Function.prototype.toString()");
}

shared_ptr<Value> _Boolean (shared_ptr<Value> thisArg, shared_ptr<Scope> scope, vector<shared_ptr<Value> > arguments) {
  if (arguments.size() == 0) return make_shared<Boolean>(false);
  return ToBoolean(arguments[0]);
}

shared_ptr<Value> _Boolean_toString (shared_ptr<Value> thisArg, shared_ptr<Scope> scope, vector<shared_ptr<Value> > arguments) {
  // TODO: needs the context of a `this` arg
  throw new NotImplementedException("Boolean.prototype.toString()");
}

shared_ptr<Value> _Boolean_valueOf (shared_ptr<Value> thisArg, shared_ptr<Scope> scope, vector<shared_ptr<Value> > arguments) {
  // TODO: needs the context of a `this` arg
  throw new NotImplementedException("Boolean.prototype.valueOf()");
}

void init_builtin_objects (shared_ptr<Scope> globalScope) {
  shared_ptr<Object> FunctionPrototype = make_shared<Object>(nullptr, nullptr);
  ...
  shared_ptr<Object> BooleanPrototype = make_shared<Object>(nullptr, nullptr);
